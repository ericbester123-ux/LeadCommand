...
export function CampaignCharts({ metrics }: CampaignChartsProps) {
  if (!metrics.length) {
    return (
      <section className="rounded-lg border border-white/10 bg-card p-6 text-center">
        <h2 className="text-lg font-semibold text-white">Reporting Pending</h2>
        <p className="mt-2 text-sm leading-6 text-muted">
          This location does not have campaign reporting data yet. Once leads
          and appointments start syncing, charts will appear here.
        </p>
      </section>
    );
  }
